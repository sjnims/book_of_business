...
class ServiceStatusUpdateJobTest < ActiveJob::TestCase
  ...
  test "does not update active services still within term" do
    ...
    active_service = @order.services.create!(
      ...
      status: "active",
      term_months_as_sold: 12,
      billing_start_date_as_sold: 6.months.ago,
      billing_end_date_as_sold: 6.months.from_now,
      rev_rec_start_date_as_sold: 6.months.ago,
      rev_rec_end_date_as_sold: 6.months.from_now,
      units: 1,
      unit_price: 1000,
      nrcs: 0,
      annual_escalator: 3
