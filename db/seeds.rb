    ...
    services: [
      {
        ...
        billing_start_date_as_sold: 2.months.ago,
        billing_end_date_as_sold: 2.months.ago + 36.months - 1.day,
        rev_rec_start_date_as_sold: 2.months.ago,
        rev_rec_end_date_as_sold: 2.months.ago + 36.months - 1.day,
        units: 1,
        unit_price: 500.00,
        nrcs: 1000.00,
    ...
    services: [
      {
        ...
        billing_start_date_as_sold: 5.months.ago,
        billing_end_date_as_sold: 5.months.ago + 24.months - 1.day,
        rev_rec_start_date_as_sold: 5.months.ago,
        rev_rec_end_date_as_sold: 5.months.ago + 24.months - 1.day,
        units: 2,
        unit_price: 300.00,
        nrcs: 0.00,
    ...
    services: [
      {
        ...
        service_type: "cloud",
        term_months_as_sold: 24,
        billing_start_date_as_sold: 23.months.ago,
        billing_end_date_as_sold: 23.months.ago + 24.months - 1.day,
        rev_rec_start_date_as_sold: 23.months.ago,
        rev_rec_end_date_as_sold: 23.months.ago + 24.months - 1.day,
        units: 10,
        unit_price: 100.00,
        nrcs: 0.00,
...
if original_order && !Order.exists?(order_number: "ORD-2024-003")
  ...
  original_order.services.each do |original_service|
    renewal_order.services.create!(
      ...
      term_months_as_sold: 24,
      billing_start_date_as_sold: 1.month.from_now,
      billing_end_date_as_sold: 1.month.from_now + 24.months - 1.day,
      rev_rec_start_date_as_sold: 1.month.from_now,
      rev_rec_end_date_as_sold: 1.month.from_now + 24.months - 1.day,
